...
InclusiveMESI::doRequest(MemoryTransport transport, bool has_maf_entry,
...
// TransactionTracker_p tracker) {
Action InclusiveMESI::handleIprobe([[maybe_unused]] bool aHit, MemoryTransport transport) {
